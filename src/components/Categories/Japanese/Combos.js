    ...
    return(
      <div className=" category-introduction japanese-makis" >
        ...
        <table>
          ...
          <tbody>
            {this.props.listItem("Sushi and Sashimi Combination"," ", 20.95)}
            <tr>
